...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* ── Live status pill ──────────────────────────────────────────────── */}
      {!collapsed && (
        <div className="mx-4 mt-4 px-3 py-2.5 rounded-xl bg-slate-50 border border-slate-200/60 shadow-sm">
          <div className="flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse flex-shrink-0" />
            <span className="text-[10px] font-bold text-emerald-600 uppercase tracking-wider">All Systems Operational</span>
          </div>
          <p className="text-[10px] text-slate-500 mt-1 font-medium">15 Jun 2026 · 22:30 PKT</p>
        </div>
      )}
        ...
        <div className="mx-3 mt-3">
          ...
          <div className="relative">
            <select
              ...
              className="w-full bg-white border border-slate-200 rounded-lg pl-8 pr-8 py-1.5 text-xs font-semibold text-slate-600 hover:text-slate-900 hover:border-slate-300 focus:outline-none focus:ring-1 focus:ring-blue-500/50 transition-all cursor-pointer appearance-none shadow-sm"
            >
