    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs">
          <p className="text-[11px] font-bold uppercase tracking-wider text-slate-500">Recognized Premium</p>
          <p className="text-xl font-black text-slate-900 mt-1 tabular-nums">{fmtPKR(premium)}</p>
          <p className="text-[10px] font-medium text-slate-400 mt-0.5">Policy Base Amount</p>
        </div>

        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs">
          <p className="text-[11px] font-bold uppercase tracking-wider text-slate-500">Total Gross Commission</p>
          <p className="text-xl font-black text-slate-900 mt-1 tabular-nums">{fmtPKR(result?.totalGross ?? 0)}</p>
          <p className="text-[10px] font-bold text-blue-600 mt-0.5">
            {fmtPct(result?.effectiveRatePct ?? 0)} Effective Rate
          </p>
        </div>

        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs">
          <p className="text-[11px] font-bold uppercase tracking-wider text-slate-500">Statutory Tax & Deductions</p>
          <p className="text-xl font-black text-rose-600 mt-1 tabular-nums">- {fmtPKR(taxDeductions)}</p>
          <p className="text-[10px] font-medium text-slate-400 mt-0.5">Withholding Tax Withheld</p>
        </div>

        <div className="bg-blue-600 text-white p-4 rounded-xl shadow-xs">
          <p className="text-[11px] font-bold uppercase tracking-wider text-blue-100">Net Payable Commission</p>
          <p className="text-xl font-black mt-1 tabular-nums">{fmtPKR(result?.totalNet ?? 0)}</p>
          <p className="text-[10px] font-medium text-blue-200 mt-0.5">
            {result?.entries.length ?? 0} Waterfall Entries Generated
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 space-y-4">
          <Card title="Policy & Premium Parameters" subtitle="Specify the premium event details, distribution channel, and payment type">
          ...
          <Card title="Parties to the Sale & Splits" subtitle="Assign producer commission percentages and channel management roles">
      ...
      <Card title="Computed Waterfall Ledger Entries" subtitle="Detailed entry-by-entry breakdown generated by the commission engine for this transaction">
