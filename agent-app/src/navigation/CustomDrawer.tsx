...
export default function CustomDrawer(props: DrawerContentComponentProps) {
  ...
  const links: DrawerLink[] = [
    ...
    { route: 'PrePolicyIssuance', label: 'Pre-Issuance', icon: 'clipboard-outline', onRootStack: true },
    { route: 'PostPolicyIssuance', label: 'Post-Issuance', icon: 'ribbon-outline', onRootStack: true },
